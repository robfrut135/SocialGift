...
public class UserGiversListActivity extends FragmentActivity {
	...
	protected void onResume() {
	 	...
	 	title_.setText("Top user givers");
	 	columnKey.setText("User");
	 	
	 	refreshUserGiversList();
	}
	...
	private void refreshUserGiversList() {
		...
		CallableTask.invoke(new Callable<Collection<GiversInfo>>() {
			...
			public void error(Exception e) {
				Toast.makeText(UserGiversListActivity.this, "Top user givers not loaded.", Toast.LENGTH_SHORT).show();					
			}
		});      
  	}
