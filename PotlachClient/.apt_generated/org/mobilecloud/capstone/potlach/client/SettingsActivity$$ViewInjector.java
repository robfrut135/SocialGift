...
public class SettingsActivity$$ViewInjector {
  public static void inject(Finder finder, final org.mobilecloud.capstone.potlach.client.SettingsActivity target, Object source) {
    View view;
    view = finder.findRequiredView(source, 2131296296, "field 'oldPassword_'");
    target.oldPassword_ = (android.widget.EditText) view;
    ...
    view = finder.findRequiredView(source, 2131296297, "method 'settings'");
  ...
  public static void reset(org.mobilecloud.capstone.potlach.client.SettingsActivity target) {
    target.oldPassword_ = null;
